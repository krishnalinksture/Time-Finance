...
if ( is_active_sidebar( 'footer-column-1' ) || ! empty( $main_title ) || ! empty( $trustpilot ) || ! empty( $mail ) || ! empty( $pop_up_title ) || ! empty( $pop_up_form ) || ! empty( $footer_logo ) || ! empty( $footer_address ) || ! empty( $footer_content ) || have_rows( 'footer_social_icon', 'options' ) ) {
	?>
	<footer>
		<div class="container">
			<div class="row">

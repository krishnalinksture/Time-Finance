...
$case_study_all_articles_button = get_field( 'case_study_all_articles_button', 'options' );
		...
		<div class="row justify-content-center">
			<div class="col-lg-4 col-md-12 order-1 order-lg-0 left">
				<div class="case-study-detail-content sticky-top">
					...
					<?php
					if ( $case_study_all_articles_button && ! empty( $case_study_all_articles_button['url'] ) && ! empty( $case_study_all_articles_button['title'] ) ) {
						$link_url    = $case_study_all_articles_button['url'];
						$link_title  = $case_study_all_articles_button['title'];
						$link_target = $case_study_all_articles_button['target'] ? $case_study_all_articles_button['target'] : '_self';
						?>
